...
sh "mvn clean verify sonar:sonar -Dsonar.host.url='http://172.17.0.1:9000' -Dsonar.projectName='example-project' -Dsonar.projectKey='example-project' -Dsonar.projectVersion=$BUILD_NUMBER;"
}
